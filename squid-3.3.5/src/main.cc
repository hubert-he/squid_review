...
static int icpPortNumOverride = 1;	/* Want to detect "-u 0"  Specify ICP port number (default: CACHE_ICP_PORT 3130), disable with 0. */
...
mainParseOptions(int argc, char *argv[])
{
...
#endif
    {
        ...
        case 'C':
            ...
            opt_catch_signals = 0;  //Note: Do not catch fatal signals.
            break;
        ...
        case 'F':
            ...
            opt_foreground_rebuild = 1; // Don't serve any requests until store is rebuilt.
            break;

        case 'N':
            /** \par N
             * Set global option for 'no_daemon' mode. opt_no_daemon */
            opt_no_daemon = 1;// No daemon mode.
            break;
        ...
        case 'R':
            ...
            opt_reuseaddr = 0; // Do not set REUSEADDR on port.
            break;

        case 'S':
            /** \par S
             * Set global option opt_store_doublecheck */
            opt_store_doublecheck = 1; //Double-check swap during rebuild.
            break;
        ...
        case 'Y':
            ...
            opt_reload_hit_only = 1; // Only return UDP_HIT or UDP_MISS_NOFETCH during fast reload.
            break;
        ...
        case 'a'://Specify HTTP port number (default: CACHE_HTTP_PORT 3128).
        ...
        case 'l': // Enable logging to syslog.
            /** \par l
        ...
        case 's': // Enable logging to syslog.
            /** \par s
        ...
        case 'u': //Specify ICP port number (default: CACHE_ICP_PORT 3130), disable with 0.
            /** \par u
        ...
        case 'z': // Create missing swap directories and then exit.
            /** \par z
...
serverConnectionsOpen(void)
{
...
#if USE_WCCP   // Web Cache Communication Protocol
        wccpConnectionOpen();
#endif
    ...
    if (IamWorkerProcess()) {
        clientOpenListenSockets(); // open squid listen port
        icpOpenPorts(); // Internet Cache Protocol
#if USE_HTCP  //HyperText Caching Protocol
        htcpOpenPorts();
#endif
#if SQUID_SNMP
        snmpOpenPorts();
