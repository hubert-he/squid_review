                ...
                ClientStreamData data)
{
	...
	// CBDATA_clientStreamNode ?  CBDATA_UNKNOWN : \
	// (CBDATA_clientStreamNode = cbdataInternalAddType(CBDATA_clientStreamNode, clientStreamNode, sizeof(clientStreamNode), clientStreamFree));
 ...
 */
// (&http->client_stream, clientGetMoreData, clientReplyDetach,
